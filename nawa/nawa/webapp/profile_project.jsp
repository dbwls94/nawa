...
<div id="nawa_contents_wrap">
	...
	<div id="user_activity">
		...
		<ul class="tab_title_list">
			<li class="on"><a href="<%=urlPath%>/profile_project.jsp?email=<%=email%>"><div class="tab_title">프로젝트</div><div class="number"></div></a></li>
			<li><a href="<%=urlPath%>/profile_following.jsp?email=<%=email%>"><div class="tab_title">팔로잉</div><div class="number"></div></a></li>
			<li><a href="<%=urlPath%>/profile_follower.jsp?email=<%=email%>"><div class="tab_title">팔로워</div><div class="number"></div></a></li>
		</ul>
		
		<div id="participating_project" class="result_list">
		...
		<div id="leading_project" class="result_list">
			<div class="result_title">
				추진한 프로젝트
			</div>
			<ul></ul>
